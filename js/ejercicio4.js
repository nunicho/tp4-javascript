...
let mercaderia1 = new Producto ('x498','Goma',30);
inventario.push(mercaderia1);

let mercaderia2 = new Producto ('x499','Lapiz',40);
inventario.push(mercaderia2);

let mercaderia3 = new Producto ('x500','Lapicera',50);
inventario.push(mercaderia3);
...
class Producto{ 
    ...
    constructor(codigo, nombre, precio){
      ...
      añadirEnInventario(){
        inventario.push("Código: "+this.codigo)
        inventario.push("Nombre: "+this.nombre)
        inventario.push("Precio "+this.precio)
      }
